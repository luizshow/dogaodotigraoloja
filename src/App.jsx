...
if (!isAdmin) {
  return (
    <div style={{display:'flex',justifyContent:'center',alignItems:'center',height:'100vh',background:'#111',color:'#fff',flexDirection:'column'}}>
      <h1>Área Administrativa</h1>
      <input placeholder="Usuário" value={loginUser} onChange={e=>setLoginUser(e.target.value)} style={{margin:5,padding:10}}/>
      <input placeholder="Senha" type="password" value={loginPass} onChange={e=>setLoginPass(e.target.value)} style={{margin:5,padding:10}}/>
      <button onClick={()=>{
      ...
      }} style={{padding:10,marginTop:10}}>Entrar</button>
    </div>
  )
}
