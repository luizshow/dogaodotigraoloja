          ...
          <div className="mb-6 flex items-center justify-between rounded-[28px] border border-white/15 bg-neutral-950/35 px-4 py-4 shadow-xl backdrop-blur md:px-6">
            <div className="flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border border-white/15 bg-white/10">
                ...
                <div
                  style={{ display: "none" }}
                  className="h-full w-full items-center justify-center bg-orange-500 text-xl font-black text-white"
                >
                  DT
                </div>
              </div>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 pb-10 md:grid-cols-2 md:px-10 md:pb-16">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-xl text-4xl font-black leading-tight md:text-6xl">
              O cachorro-quente mais bruto da cidade.
            </h1>
            <p className="mt-4 max-w-xl text-base text-white/90 md:text-lg">
              Monte seu pedido no carrinho e finalize direto no WhatsApp.
            </p>
      ...
      <section id="cardapio" className="mx-auto max-w-7xl px-6 py-6 md:px-10">
        <div className="mb-8">
          ...
          <div className="mt-4 rounded-2xl border border-green-500/20 bg-green-500/10 p-4 text-sm text-white/80">
            Adicionais disponíveis em qualquer lanche: <strong>Bacon +R$ 3,00</strong> e{" "}
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur">
            ...
            <div className="mt-6">
              ...
              {paymentMethod === "pix" && (
                <div className="mt-4 rounded-2xl border border-green-500/20 bg-green-500/10 p-4 text-sm text-white/80">
                  No Pix, o cliente finaliza o pedido e envia o comprovante para o número
                  <span className="font-bold text-white"> (34) 99978-3791</span> no WhatsApp.
                </div>
              )}
            </div>
          ...
          <aside className="rounded-[32px] border border-white/10 bg-gradient-to-b from-white/8 to-white/5 p-6 shadow-2xl backdrop-blur h-fit lg:sticky lg:top-6">
            ...
            <div className="mt-6 space-y-3 border-t border-white/10 pt-4 text-sm">
              ...
              <div className="rounded-2xl border border-yellow-500/20 bg-yellow-500/10 p-3 text-xs leading-relaxed text-white/75">
                Taxa de entrega inicial de R$ 3,00. Esse valor pode alterar dependendo do endereço,
                e nós te avisaremos no WhatsApp caso a taxa fique maior que R$ 3,00.
              </div>
              <div className="flex items-center justify-between text-white/70">
                <span>Pagamento</span>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <h2 className="text-3xl font-black md:text-4xl">
                Pedido rápido e direto no WhatsApp.
              </h2>
              <p className="mt-4 max-w-xl text-white/70">
                O cliente escolhe os itens, informa a forma de pagamento e envia o pedido completo automaticamente para você.
              </p>
            </div>
