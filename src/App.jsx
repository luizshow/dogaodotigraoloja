...
export default function App() {
  ...
  const [showMothersDay, setShowMothersDay] = useState(true);
  ...
  useEffect(() => {
    if (showMothersDay) {
      const timer = setTimeout(() => setShowMothersDay(false), 6000);
      ...
      {showMothersDay && (
        <div
          style={{
            ...
            animation: "mothersIn 0.6s ease both",
          }}
        >
          <style>{`
            @keyframes mothersIn {
            ...
            @keyframes textGlow {
              0%, 100% { text-shadow: 0 0 20px rgba(255,150,150,0.6); }
              50% { text-shadow: 0 0 40px rgba(255,150,150,1), 0 0 80px rgba(255,100,100,0.5); }
            }
            @keyframes fadeSlideUpModal {
              from { opacity: 0; transform: translateY(30px); }
              to   { opacity: 1; transform: translateY(0); }
            }
            .rose { position: fixed; top: -60px; font-size: 28px; animation: roseFall linear infinite; user-select: none; pointer-events: none; }
          `}</style>

          {[
            { left: "5%",  delay: "0s",    dur: "4.2s",  size: "28px" },
            { left: "12%", delay: "0.7s",  dur: "5.1s",  size: "22px" },
            { left: "20%", delay: "1.4s",  dur: "3.8s",  size: "32px" },
            { left: "28%", delay: "0.3s",  dur: "4.7s",  size: "24px" },
            { left: "36%", delay: "1.1s",  dur: "5.3s",  size: "20px" },
            { left: "44%", delay: "0.5s",  dur: "4.0s",  size: "30px" },
            { left: "52%", delay: "1.8s",  dur: "3.6s",  size: "26px" },
            { left: "60%", delay: "0.2s",  dur: "4.9s",  size: "22px" },
            { left: "68%", delay: "1.3s",  dur: "4.4s",  size: "28px" },
            { left: "76%", delay: "0.8s",  dur: "3.9s",  size: "20px" },
            { left: "84%", delay: "0.4s",  dur: "5.2s",  size: "34px" },
            { left: "92%", delay: "1.6s",  dur: "4.1s",  size: "24px" },
            { left: "8%",  delay: "2.1s",  dur: "4.6s",  size: "18px" },
            { left: "48%", delay: "2.5s",  dur: "3.7s",  size: "28px" },
            { left: "72%", delay: "2.0s",  dur: "5.0s",  size: "22px" },
          ].map((r, i) => (
            <span
              key={i}
              className="rose"
          ...
          <div style={{
            textAlign: "center", padding: "2rem", maxWidth: "440px", position: "relative", zIndex: 10,
            animation: "fadeSlideUpModal 0.8s ease 0.3s both",
          }}>
            <div style={{
            ...
            <p style={{
              ...
              Do Dogão do Tigrão com muito carinho 🧡
            </p>
            <p style={{
              ...
              Celebre esse dia especial com um dogão delicioso!
            </p>
            <button
              onClick={() => setShowMothersDay(false)}
              style={{
