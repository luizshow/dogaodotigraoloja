...
export default function App() {
  ...
  const products = [
    ...
    { id: 31, name: "X.frango", category: "Frango", price: 28, image: `${base}images/frango.jpg`, description: "Pão, frango e queijo.", badge: "Lanche" },
    { id: 32, name: "X.frango salada", category: "Frango", price: 29, image: `${base}images/frango.jpg`, description: "Pão, frango, queijo e salada.", badge: "Lanche" },
    { id: 33, name: "X.frango egg", category: "Frango", price: 29, image: `${base}images/frango.jpg`, description: "Pão, frango, queijo e ovo.", badge: "Lanche" },
    { id: 34, name: "X.frango bacon", category: "Frango", price: 30, image: `${base}images/frango.jpg`, description: "Pão, frango, queijo e bacon.", badge: "Lanche" },
    { id: 35, name: "X.frango salada egg", category: "Frango", price: 31, image: `${base}images/frango-especial.jpg`, description: "Pão, frango, queijo, ovo e salada.", badge: "Lanche" },
    { id: 36, name: "X.frango bacon egg", category: "Frango", price: 31, image: `${base}images/frango-especial.jpg`, description: "Pão, frango, queijo, ovo e bacon.", badge: "Lanche" },
    { id: 37, name: "X.frango bacon salada", category: "Frango", price: 32, image: `${base}images/frango-especial.jpg`, description: "Pão, frango, queijo, bacon e salada.", badge: "Lanche" },
    { id: 38, name: "X.frango tudo", category: "Frango", price: 38, image: `${base}images/o-brabo.jpg`, description: "Pão, frango, queijo, ovo, salsinha, bacon, salada e presunto.", badge: "Especial" },

    { id: 39, name: "X.lombo", category: "Lombo", price: 28, image: `${base}images/carne.jpg`, description: "Pão, lombo e queijo.", badge: "Lanche" },
    { id: 40, name: "X.lombo salada", category: "Lombo", price: 29, image: `${base}images/carne.jpg`, description: "Pão, lombo, queijo e salada.", badge: "Lanche" },
    { id: 41, name: "X.lombo egg", category: "Lombo", price: 29, image: `${base}images/carne.jpg`, description: "Pão, lombo, queijo e ovo.", badge: "Lanche" },
    { id: 42, name: "X.lombo bacon", category: "Lombo", price: 30, image: `${base}images/carne.jpg`, description: "Pão, lombo, queijo e bacon.", badge: "Lanche" },
    { id: 43, name: "X.lombo salada egg", category: "Lombo", price: 31, image: `${base}images/carne-especial.jpg`, description: "Pão, lombo, queijo, ovo e salada.", badge: "Lanche" },
    { id: 44, name: "X.lombo bacon egg", category: "Lombo", price: 31, image: `${base}images/carne-especial.jpg`, description: "Pão, lombo, queijo, ovo e bacon.", badge: "Lanche" },
    { id: 45, name: "X.lombo bacon salada", category: "Lombo", price: 32, image: `${base}images/carne-especial.jpg`, description: "Pão, lombo, queijo, bacon e salada.", badge: "Lanche" },
    { id: 46, name: "X.lombo tudo", category: "Lombo", price: 38, image: `${base}images/o-brabo-especial.jpg`, description: "Pão, lombo, queijo, ovo, salsinha, bacon, salada e presunto.", badge: "Especial" },

    { id: 47, name: "X.file", category: "Filé", price: 32, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé e queijo.", badge: "Lanche" },
    { id: 48, name: "Filé salada", category: "Filé", price: 34, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e salada.", badge: "Lanche" },
    { id: 49, name: "Filé egg", category: "Filé", price: 34, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e ovo.", badge: "Lanche" },
    { id: 50, name: "Filé bacon", category: "Filé", price: 36, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e bacon.", badge: "Lanche" },
    { id: 51, name: "Filé salada egg", category: "Filé", price: 35, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, ovo e salada.", badge: "Lanche" },
    { id: 52, name: "Filé bacon egg", category: "Filé", price: 37, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, ovo e bacon.", badge: "Lanche" },
    { id: 53, name: "Filé bacon salada", category: "Filé", price: 37, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, bacon e salada.", badge: "Lanche" },
    { id: 54, name: "Filé tudo", category: "Filé", price: 42, image: `${base}images/o-brabo-especial.jpg`, description: "Pão, filé, queijo, ovo, salsinha, bacon, presunto e salada.", badge: "Especial" },

    { id: 55, name: "X.hambúrguer", category: "Hambúrguer", price: 28, image: `${base}images/tradicional.jpg`, description: "Pão, hambúrguer e queijo.", badge: "Lanche" },
    { id: 56, name: "X.hambúrguer salada", category: "Hambúrguer", price: 29, image: `${base}images/tradicional.jpg`, description: "Pão, hambúrguer, queijo e salada.", badge: "Lanche" },
    { id: 57, name: "X.hambúrguer egg", category: "Hambúrguer", price: 29, image: `${base}images/tradicional-especial.jpg`, description: "Pão, hambúrguer, queijo e ovo.", badge: "Lanche" },
    { id: 58, name: "X.hambúrguer bacon", category: "Hambúrguer", price: 30, image: `${base}images/o-brabo.jpg`, description: "Pão, hambúrguer, queijo e bacon.", badge: "Lanche" },
    { id: 59, name: "X.hambúrguer salada egg", category: "Hambúrguer", price: 31, image: `${base}images/tradicional-especial.jpg`, description: "Pão, hambúrguer, queijo, ovo e salada.", badge: "Lanche" },
    { id: 60, name: "X.hambúrguer bacon egg", category: "Hambúrguer", price: 31, image: `${base}images/o-brabo.jpg`, description: "Pão, hambúrguer, queijo, ovo e bacon.", badge: "Lanche" },
    ...
    { id: 67, name: "Big Tiger", category: "Diversos", price: 49, image: `${base}images/o-brabo-especial.jpg`, description: "Pão, hambúrguer, frango, lombo, salsinha, bacon, ovo, queijo, presunto e salada.", badge: "Gigante" },
  ];

  const featured = products.find((product) => product.name === "Big Tiger") || products[0];
...
{showAdmin && !isAdmin && (
  <div style={{position:'fixed',top:0,left:0,width:'100%',height:'100%',background:'#000000dd',display:'flex',justifyContent:'center',alignItems:'center',zIndex:9999}}>
    <div style={{background:'#111',padding:20,borderRadius:10}}>
      <h2>Login Admin</h2>
      <input placeholder="Usuário" value={loginUser} onChange={e=>setLoginUser(e.target.value)} style={{display:'block',margin:5,padding:10}}/>
      <input type="password" placeholder="Senha" value={loginPass} onChange={e=>setLoginPass(e.target.value)} style={{display:'block',margin:5,padding:10}}/>
      <button onClick={()=>{
...
{isAdmin && (
  <div style={{position:'fixed',bottom:20,left:20,background:'green',padding:10,borderRadius:10}}>
    ADMIN ATIVO
  </div>
)}
...
<div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          >
            ...
            <button
              ...
              className="mt-6 w-full rounded-2xl bg-green-500 py-4 text-base font-black text-white transition hover:scale-[1.01]"
            >
      ...
      >
        Admin</button>
<button onClick={()=>setShowAdmin(true)} style={{position:'fixed',top:20,right:20,zIndex:999}}>Admin</button>
Carrinho ({cartCount})
      </button>
    </div>
  );
