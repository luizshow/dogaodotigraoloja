...
export default function App() {
  ...
  const products = [
    ...
    { id: 47, name: "X.filé", category: "Filé", price: 28, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé e queijo.", badge: "Lanche" },
    { id: 48, name: "X.filé salada", category: "Filé", price: 29, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e salada.", badge: "Lanche" },
    { id: 49, name: "X.filé egg", category: "Filé", price: 29, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e ovo.", badge: "Lanche" },
    { id: 50, name: "X.filé bacon", category: "Filé", price: 30, image: `${base}images/misto-luizshow.jpg`, description: "Pão, filé, queijo e bacon.", badge: "Lanche" },
    { id: 51, name: "X.filé salada egg", category: "Filé", price: 31, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, ovo e salada.", badge: "Lanche" },
    { id: 52, name: "X.filé bacon egg", category: "Filé", price: 31, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, ovo e bacon.", badge: "Lanche" },
    { id: 53, name: "X.filé bacon salada", category: "Filé", price: 32, image: `${base}images/misto-luizshow-especial.jpg`, description: "Pão, filé, queijo, bacon e salada.", badge: "Lanche" },
    { id: 54, name: "X.filé tudo", category: "Filé", price: 38, image: `${base}images/o-brabo-especial.jpg`, description: "Pão, filé, queijo, ovo, salsinha, bacon, presunto e salada.", badge: "Especial" },
