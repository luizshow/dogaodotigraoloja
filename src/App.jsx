...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      {showMothersDay && (
        <div className="mothers-overlay">
          {[
            { left: "4%",  delay: "0s",    dur: "4.2s" },
            { left: "11%", delay: "0.8s",  dur: "5.0s" },
            { left: "18%", delay: "1.5s",  dur: "3.8s" },
            { left: "25%", delay: "0.3s",  dur: "4.7s" },
            { left: "33%", delay: "1.2s",  dur: "5.3s" },
            { left: "41%", delay: "0.6s",  dur: "4.0s" },
            { left: "49%", delay: "1.9s",  dur: "3.6s" },
            { left: "57%", delay: "0.1s",  dur: "4.9s" },
            { left: "65%", delay: "1.4s",  dur: "4.4s" },
            { left: "73%", delay: "0.9s",  dur: "3.9s" },
            { left: "81%", delay: "0.4s",  dur: "5.2s" },
            { left: "89%", delay: "1.7s",  dur: "4.1s" },
            { left: "96%", delay: "0.5s",  dur: "4.6s" },
            { left: "8%",  delay: "2.2s",  dur: "3.7s" },
            { left: "37%", delay: "2.6s",  dur: "5.0s" },
            { left: "62%", delay: "2.0s",  dur: "4.3s" },
            { left: "85%", delay: "2.4s",  dur: "3.5s" },
          ].map((r, i) => (
            <span
              key={i}
              className="mothers-rose"
          ...
          <div className="mothers-content">
            <span className="mothers-heart">💐</span>
            <h1 className="mothers-title">Feliz Dia das Mães!</h1>
            <p className="mothers-sub">Do Dogão do Tigrão com muito carinho 🧡</p>
            <p className="mothers-desc">Celebre esse dia especial com um dogão delicioso!</p>
            <button className="mothers-btn" onClick={() => setShowMothersDay(false)}>
              Ver cardápio 🌹
            </button>
          </div>

          <span className="mothers-hint">Fechando automaticamente em instantes...</span>
        </div>
      )}
    </div>
  );
