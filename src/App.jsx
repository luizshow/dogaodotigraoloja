...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-6 md:px-10">
          <div className="mb-6 flex items-center justify-between rounded-[28px] border border-white/15 bg-neutral-950/35 px-5 py-4 shadow-xl backdrop-blur md:px-7">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-lg font-black text-white sm:text-2xl md:text-3xl">Dogão do Tigrão</h2>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Link
                to="/admin"
                className="rounded-2xl bg-white/10 px-3 py-2.5 text-xs font-bold text-white transition hover:bg-white/20 sm:px-4 sm:py-3 sm:text-sm"
                title="Painel Admin"
              >
                  ...
                  <>
                    <div className="mb-4 flex items-center justify-between gap-4">
                      ...
                      <div className="rounded-2xl bg-orange-500 px-4 py-2 text-sm font-bold">
                        R$ {Number(featured.price).toFixed(2)}
                      </div>
                    </div>
                    <img
                      src={featured.image}
      ...
      <section id="cardapio" className="mx-auto max-w-7xl px-4 py-6 sm:px-6 md:px-10">
        <div className="mb-8">
        ...
        <div className="mb-8 flex flex-wrap gap-3">
          {categories.map((category) => (
            <button
              ...
              className={`rounded-2xl px-3 py-2 text-sm font-bold transition-all duration-200 sm:px-5 sm:py-3 sm:text-base ${
      ...
      <section id="checkout" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 md:px-10 md:py-12">
        <div className="grid gap-6 grid-cols-1 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside
            id="cart-panel"
            className="rounded-[32px] border border-white/10 bg-gradient-to-b from-white/8 to-white/5 p-4 sm:p-6 shadow-2xl backdrop-blur h-fit lg:sticky lg:top-6" id="cart-panel"
          >
